...
const KzrLab3 = () => {
	...
	const memoizeExpensiveFunction = useMemo(() => expensiveFunction('fromUseMemo'), []);
	...
	return (
		<SafeAreaView style = {styles.kzrSafeArea}>
			...
			<Text style={styles.kzrItemText}>number from callback: {callbackNum}</Text>
			...
			<RoundedButton onPress={memoizedCallback} title='counter using useCallback'/>
